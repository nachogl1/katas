...
So what will be your task? You should write a function ,that takes one parameter steps, and returns a number from the Fibonacci sequence, based on the parameter steps,
